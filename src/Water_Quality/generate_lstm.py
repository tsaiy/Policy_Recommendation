...
Original file is located at
    https://colab.research.google.com/drive/1LtWAHXuyca9Fo9eMiDqWScYEZ2NezeV4
"""

from google.colab import drive
drive.mount('/content/drive/MyDrive/Conservatives-Official/Water_quality/')
...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 18:51:52 2024
...
file_path = '/content/drive/MyDrive/Conservatives-Official/Water_Quality/water_data_SouthDakota.csv'

df1 = pd.read_csv(file_path)


unique_values_count = df1['Countyname'].value_counts()

sorted_counts = unique_values_count.sort_values(ascending=False)



filtered_df = df1[df1['Countyname'] == 'Pennington']
...
model.save('/content/drive/MyDrive/Conservatives-Official/Water_Quality/model.h5')

import pickle
from tensorflow.keras.models import load_model

# Assuming 'model' is your Keras model
model.save('/content/drive/MyDrive/Conservatives-Official/Water_Quality/temporary_model.h5')  # First, save your model in H5 format

# Then, load it back (this step is optional and just for demonstration)
model = load_model('/content/drive/MyDrive/Conservatives-Official/Water_Quality/temporary_model.h5')
...
for site_no in site_numbers:
    ...
    model = Sequential()
    model.add(LSTM(36, input_shape=(1, look_back)))  # Use 24 units for LSTM layer
    model.add(Dropout(0.0))  # Apply dropout with a rate of 0.4
    model.add(Dense(1))
